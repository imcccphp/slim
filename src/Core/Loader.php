...
class Loader
{
    ...
    {
        // 注册系统自动加载
        spl_autoload_register($autoload ?: 'Imccc\\Slim\\Core\\Loader::autoload', true, true);
        // 注册命名空间定义
        self::addNamespace([
            'imccc' => LIB_PATH . 'imccc' . DS . 'src' . DS . 'Core' . DS,
            'expend' => LIB_PATH . 'imccc' . DS . 'src' . DS . 'Expend' . DS,
            'mvc' => LIB_PATH . 'imccc' . DS . 'src' . DS . 'Mvc' . DS,
        ]);
        // 加载类库映射文件
